-- ============================================
-- RAG SYSTEM SCHEMA - STEP 2: Tables & Functions
...
-- For smaller datasets, we'll create the index but it will work fine
...
-- ============================================
-- FUNCTION: find_scripts_for_weakness
...
DROP POLICY IF EXISTS "Allow read access to knowledge base" ON "Sandler_Knowledge_Base";
...
DROP POLICY IF EXISTS "Allow service role to manage knowledge base" ON "Sandler_Knowledge_Base";
...
SELECT 'Sandler_Knowledge_Base' as table_name, COUNT(*) as row_count FROM "Sandler_Knowledge_Base"
UNION ALL
SELECT 'Embedding_Cache' as table_name, COUNT(*) as row_count FROM "Embedding_Cache";
