-- ============================================
-- PART 2: CREATE INTEGRATION TABLES & FUNCTIONS
...
-- Create RPC function: save_hubspot_connection
...
-- Create RPC function: get_hubspot_connection
...
-- Create RPC function: save_fathom_connection
...
-- Create RPC function: get_fathom_connection
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '======================================';
    RAISE NOTICE '✅ PART 2 COMPLETE - ALL DONE!';
    RAISE NOTICE '======================================';
    RAISE NOTICE '';
    RAISE NOTICE 'Created:';
    RAISE NOTICE '  • API_Connections table';
    RAISE NOTICE '  • Synced_Activities table';
    RAISE NOTICE '  • Synced_Conversations table';
    RAISE NOTICE '  • Integration_Sync_Log table';
    RAISE NOTICE '  • Coaching_Messages table';
    RAISE NOTICE '  • Coaching_Outcomes table';
    RAISE NOTICE '  • 9 indexes';
    RAISE NOTICE '  • 4 RPC functions';
    RAISE NOTICE '';
