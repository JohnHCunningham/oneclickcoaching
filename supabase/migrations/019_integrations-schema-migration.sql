-- ============================================
-- SANDLER REVENUE FACTORY - MIGRATION SCRIPT
-- Adds integration tables + updates existing tables
-- ============================================
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '✓ account_id column already exists in User_Roles';
    END IF;
END $$;
...
-- Step 3: Create Conversation_Analyses table
...
-- Step 7: Create default account and update existing users
DO $$
DECLARE
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '======================================';
    RAISE NOTICE '✅ INTEGRATION MIGRATION COMPLETE!';
    RAISE NOTICE '======================================';
    RAISE NOTICE '';
    RAISE NOTICE 'Created/Updated:';
    RAISE NOTICE '  • Accounts table';
    RAISE NOTICE '  • User_Roles table (added account_id)';
