...
-- Create default account if it doesn't exist (without industry column)
INSERT INTO "Accounts" (id, company_name, created_at)
VALUES ('00000000-0000-0000-0000-000000000001', 'Default Account', NOW())
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Created 9 indexes for performance';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🚀 Integration infrastructure ready!';
    RAISE NOTICE '📖 Next step: Follow HUBSPOT-INTEGRATION-SETUP.md';
    RAISE NOTICE '';
END $$;
